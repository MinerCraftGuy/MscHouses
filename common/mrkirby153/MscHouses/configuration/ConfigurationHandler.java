...
public class ConfigurationHandler {
	...
	public static void init(File configFile){
		...
		ConfigurationSettings.DISPLAY_VERSION_RESULT = config.get(config.CATEGORY_GENERAL, ConfigurationSettings.DISPLAY_VERSION_RESULT_CONFIGNAME, ConfigurationSettings.DISPLAY_VERSION_RESULT_DEFAULT).getBoolean(ConfigurationSettings.DISPLAY_VERSION_RESULT_DEFAULT);
