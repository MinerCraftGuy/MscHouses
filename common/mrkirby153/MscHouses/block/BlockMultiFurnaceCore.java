...
public class BlockMultiFurnaceCore extends BlockContainer {
	...
	public static final int META_ISACTIVE= 0x0000008;
	...
	public void registerIcons(IconRegister iconRegister){
		blockIcon = iconRegister.registerIcon("MscHouses:brick");
		faceIconUnlit = iconRegister.registerIcon("MscHouses:MultiFurnace_Front_Unlit");
		faceIconLit = iconRegister.registerIcon("MscHouses:MultiFurnace_Front_Lit");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
	{
		...
		if(tileEntity != null)
		{
			...
			if(tileEntity.getIsValid())
				player.openGui(MscHouses.instance, 1, world, x, y, z);
		}
	...
	public void randomDisplayTick(World world, int x, int y, int z, Random prng)
	{
		...
		int rand = prng.nextInt(10);
		if(rand > 7)
			world.playSound(x, y, z, "random.explode", 1F, 0, true);
	}
	@Override
